$(document).ready(function () {
    ...
    const KE1701PIntroImages = document.querySelectorAll('.KE1701P-intro .KE1701P-media-layers .KE1701P-media-layer');
    const KE1701PIntroPaginationItems = document.querySelectorAll('.KE1701P-intro .KE1701P-media-pagination .KE1701P-media-layer');
    ...
    KE1701PIntroPaginationItems.forEach((paginationItem, index) => {
        ...
        paginationItem.addEventListener('mouseover', (e) => {
            ...
            toggleActiveImages(KE1701PIntroImages[currentIndex], currentIndex, KE1701PIntroImages);
        });
    });

    // scroll design section animation
    const KE1701PDesignImages = document.querySelectorAll('.KE1701P-design .KE1701P-media-figure .KE1701P-media-layer');
