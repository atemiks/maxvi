$(document).ready(function () {
    ...
    // scroll animation
    const HD1801InitDesignAnimation = () => {
        ...
        const HD1801DesignImages = document.querySelectorAll('.HD1801-design .HD1801-media-figure-desktop .HD1801-media-layer');
