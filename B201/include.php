...
>
        ...
        <div class="container">
            <div class="content-wrapper row d-flex">
                ...
                >
                    ...
                    <div class="B210-intro-model">B201</div>
                </div>
    ...
    <section class="B210-presentation">
        <div class="B210-presentation-scene">
                ...
                <div class="content-wrapper row d-flex">
                    ...
                    >
                        <div class="B210-keyboard-block">
                            ...
                            <div
                                class="B210-keyboard-description"
                                data-aos="fade-right"
                                data-aos-duration="500"
                            >
                                Пользуйтесь
                    ...
                    <div
                        class="B210-media-container col-xs-12 col-sm-5"
                    >
                        <figure
    ...
    <section class="B210-slots section-dark">
        <div class="container">
            <div class="content-wrapper row d-flex">
                <div class="B210-media-container col-xs-12">
                    <figure class="B210-slots-figure">
                        <img
                            loading="lazy"
                        ...
                        <div
                            ...
                            data-aos="fade-in"
                            data-aos-duration="800"
                            data-aos-achor=".B210-slots-figure"
                            style="
    ...
    <section class="B210-camera section-dark">
        <div class="container">
            <div class="content-wrapper row d-flex">
                ...
                <div
                    class="B210-media-container col-xs-12 col-sm-7 col-sm-offset-1"
                >
                    <figure class="B210-camera-figure">
                        <div
                            class="B210-camera-flashlight"
                            data-aos="fade-in"
                            data-aos-duration="800"
                            data-aos-delay="800"
                            data-aos-achor=".B210-camera-figure"
                            style="
